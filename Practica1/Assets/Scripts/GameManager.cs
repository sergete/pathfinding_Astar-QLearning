...
namespace Assets.Scripts
{
    public class GameManager : MonoBehaviour
    {
        ...
        //Método para activar dont destroy on load en el método offlineRandomMind y permanecerá desactivado en la clase QlearningRandomMind
        //para poder recargar el nivel
        public void ActiveDontDestroyOnLoad()
        {
            Debug.Log("Activado dont destroy on load");
            DontDestroyOnLoad(gameObject);
        }
